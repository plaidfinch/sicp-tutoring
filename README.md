...
1. Run `./tutor` — installs [Claude Code](https://claude.com/product/claude-code) if needed, then guides you through setup (including [Racket/DrRacket](https://www.racket-lang.org/))
